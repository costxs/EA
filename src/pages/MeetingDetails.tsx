            ...
            <div className="pt-32 pb-24 px-6 md:px-12 max-w-5xl mx-auto min-h-screen">
                ...
                <section className="mb-20">
                    ...
                    <div className="mt-8 bg-[#f8f5f4] p-8 md:p-10 rounded-[2rem] border border-gray-100">
                        ...
                        <p className="text-[#555] leading-[1.8] text-[0.95rem] md:text-base font-light whitespace-pre-line">
                            {meeting.expandedSummary || meeting.summary}
                        </p>
                    </div>
                </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <section>
                        ...
                        <div className="bg-white p-8 md:p-10 rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 h-full flex flex-col items-start hover:shadow-[0_10px_30px_rgba(0,0,0,0.06)] transition-shadow duration-300">
                            <h4 className="font-serif text-xl italic font-semibold text-[#222] mb-4 leading-tight">Material<br />de Leitura Base</h4>
                            <p className="text-[#444] leading-relaxed text-sm mb-8 font-normal flex-grow">
                            ...
                            <a
                                ...
                                className="inline-flex items-center justify-center px-8 py-3.5 bg-[#3d3d3d] hover:bg-[#222] text-white text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] rounded-full transition-colors duration-300 w-full md:w-auto text-center"
                            >
                                Acessar PDF
                            </a>
                        </div>
                    ...
                    <section>
                        ...
                        <div className="bg-white p-8 md:p-10 rounded-[2rem] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 h-full flex flex-col hover:shadow-[0_10px_30px_rgba(0,0,0,0.06)] transition-shadow duration-300">
                            <h4 className="font-serif text-xl italic font-semibold text-[#222] mb-6">Slides Utilizados</h4>

                            {/* Slides Placeholder (Google Slides iframe) */}
                            <div className="w-full aspect-[4/3] bg-gray-50 rounded-[1.25rem] mb-6 overflow-hidden relative border border-gray-100">
                                {/* O src agora vem dos dados do encontro (meeting.slidesIframeSrc) */}
                                <iframe
                                    src={meeting.slidesIframeSrc || ""}
                            ...
                            <a
                                href={meeting.slidesLink || ""}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="mt-auto inline-flex items-center justify-center px-8 py-3.5 border border-[#ccc] hover:border-[#333] hover:bg-[#333] hover:text-white text-[#333] text-[10px] sm:text-xs font-semibold uppercase tracking-[0.15em] rounded-full transition-all duration-300 w-full md:w-auto text-center"
                            >
                                Visualizar Completo
                            </a>
                        </div>
